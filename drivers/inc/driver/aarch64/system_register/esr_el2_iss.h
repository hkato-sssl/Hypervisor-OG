...
#define ISS_DATA_ABORT_SAS(n)           (((n) << ISS_DATA_ABORT_SAS_LSB) & ISS_DATA_ABORT_SAS_MASK)
#define EXTRACT_ISS_DATA_ABORT_SAS(d)   (((d) & ISS_DATA_ABORT_SAS_MASK) >> ISS_DATA_ABORT_SAS_LSB)
...
#define ISS_DATA_ABORT_SRT(n)           (((n) << ISS_DATA_ABORT_SRT_LSB) & ISS_DATA_ABORT_SRT_MASK)
#define EXTRACT_ISS_DATA_ABORT_SRT(d)   (((d) & ISS_DATA_ABORT_SRT_MASK) >> ISS_DATA_ABORT_SRT_LSB)
...
#define ISS_DATA_ABORT_DFSC(n)          (((n) << ISS_DATA_ABORT_DFSC_LSB) & ISS_DATA_ABORT_DFSC_MASK)
#define EXTRACT_ISS_DATA_ABORT_DFSC(d)  (((d) & ISS_DATA_ABORT_DFSC_MASK) >> ISS_DATA_ABORT_DFSC_LSB)
