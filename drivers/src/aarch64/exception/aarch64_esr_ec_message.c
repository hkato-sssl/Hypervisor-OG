...
const char *aarch64_esr_ec_message(uint32_t ec)
{
    ...
    case 0x03:  /* 0b000011 */
        msg = "Trapped MCR or MRC access with (coproc==0b1111) that is not reported using EC 0b000000";
        break;

    case 0x04:  /* 0b000100 */
        msg = "Trapped MCRR or MRRC access with (coproc==0b1111) that is not reported using EC 0b000000";
        break;
    ...
    case 0x07:  /* 0b000111 */
        msg = "Access to SVE, Advanced SIMD or floating-point functionality trapped by CPACR_EL1.FPEN or CPTR_ELx.TFP controle";
        break;

    case 0x08:  /* 0b001000 */
        msg = "Trapped VMRS access, from ID group traps, that is not reported using EC 0b000111f";
        break;
    ...
    case 0x12:  /* 0b010010 */
        msg = "HVC instruction execution in AArch32 state, when HVC is not disabled";
        break;

    case 0x13:  /* 0b010011 */
        msg = "SMC instruction execution in AArch32 state, when SMC is not disabled";
        break;
    ...
    case 0x16:  /* 0b010110 */
        msg = "HVC instruction execution in AArch64 state, when HVC is not disabled";
        break;

    case 0x17:  /* 0b010111 */
        msg = "SMC instruction execution in AArch64 state, when SMC is not disabled";
        break;

    case 0x18:  /* 0b011000 */
        msg = "Trapped MSR, MRS, or System instruction execution, that is not reported using EC 0x00, 0x01, or 0x07 When ARMv8.4-IDST is implemented, trapped ID registers";
        break;

    case 0x19:  /* 0b011001 */
        msg = "Trapped access to SVE functionality, that is not reported using EC 0b000000";
        break;
    ...
    case 0x33:  /* 0b110011 */
        msg = "Software Step exception taken without a change in Exception level";
        break;
