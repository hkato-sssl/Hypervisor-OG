...
#define STAGE2_MEMATTR_NORMAL_NC \
    (STAGE2_MEMATTR_NORMAL_ONC | STAGE2_MEMATTR_NORMAL_INC)
#define STAGE2_MEMATTR_NORMAL_WT \
    (STAGE2_MEMATTR_NORMAL_OWT | STAGE2_MEMATTR_NORMAL_IWT)
#define STAGE2_MEMATTR_NORMAL_WB \
    (STAGE2_MEMATTR_NORMAL_OWB | STAGE2_MEMATTR_NORMAL_IWB)
...
aarch64_stage2_vttbr_el2(const struct aarch64_stage2 *stage2)
{
    uint64_t d;
...
static inline uint64_t
aarch64_stage2_vtcr_el2(const struct aarch64_stage2 *stage2)
{
