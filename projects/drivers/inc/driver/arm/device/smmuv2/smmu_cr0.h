...
#define EXTRACT_SMMU_CR0_WACFG(d) \
    (((d) & SMMU_CR0_WACFG_MASK) >> SMMU_CR0_WACFG_LSB)
...
#define EXTRACT_SMMU_CR0_RACFG(d) \
    (((d) & SMMU_CR0_RACFG_MASK) >> SMMU_CR0_RACFG_LSB)
...
#define EXTRACT_SMMU_CR0_SHCFG(d) \
    (((d) & SMMU_CR0_SHCFG_MASK) >> SMMU_CR0_SHCFG_LSB)
...
#define SMMU_CR0_MEMATTR(n) \
    (((n) << SMMU_CR0_MEMATTR_LSB) & SMMU_CR0_MEMATTR_MASK)
#define EXTRACT_SMMU_CR0_MEMATTR(d) \
    (((d) & SMMU_CR0_MEMATTR_MASK) >> SMMU_CR0_MEMATTR_LSB)
...
#define SMMU_CR0_TRANSIENTCFG(n) \
    (((n) << SMMU_CR0_TRANSIENTCFG_LSB) & SMMU_CR0_TRANSIENTCFG_MASK)
#define EXTRACT_SMMU_CR0_TRANSIENTCFG(d) \
    (((d) & SMMU_CR0_TRANSIENTCFG_MASK) >> SMMU_CR0_TRANSIENTCFG_LSB)
