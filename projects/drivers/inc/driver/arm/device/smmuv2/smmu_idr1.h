...
#define SMMU_IDR1_NUMPAGENDXB(n) \
    (((n) << SMMU_IDR1_NUMPAGENDXB_LSB) & SMMU_IDR1_NUMPAGENDXB_MASK)
#define EXTRACT_SMMU_IDR1_NUMPAGENDXB(d) \
    (((d) & SMMU_IDR1_NUMPAGENDXB_MASK) >> SMMU_IDR1_NUMPAGENDXB_LSB)
#define SMMU_IDR1_HAFDBS_MASK BITS(25, 24)
#define SMMU_IDR1_HAFDBS_MSB  25
#define SMMU_IDR1_HAFDBS_LSB  24
#define SMMU_IDR1_HAFDBS(n) \
    (((n) << SMMU_IDR1_HAFDBS_LSB) & SMMU_IDR1_HAFDBS_MASK)
#define EXTRACT_SMMU_IDR1_HAFDBS(d) \
    (((d) & SMMU_IDR1_HAFDBS_MASK) >> SMMU_IDR1_HAFDBS_LSB)
#define SMMU_IDR1_NUMS2CB_MASK BITS(23, 16)
#define SMMU_IDR1_NUMS2CB_MSB  23
#define SMMU_IDR1_NUMS2CB_LSB  16
#define SMMU_IDR1_NUMS2CB(n) \
    (((n) << SMMU_IDR1_NUMS2CB_LSB) & SMMU_IDR1_NUMS2CB_MASK)
#define EXTRACT_SMMU_IDR1_NUMS2CB(d) \
    (((d) & SMMU_IDR1_NUMS2CB_MASK) >> SMMU_IDR1_NUMS2CB_LSB)
...
#define EXTRACT_SMMU_IDR1_SSDTP(d) \
    (((d) & SMMU_IDR1_SSDTP_MASK) >> SMMU_IDR1_SSDTP_LSB)
#define SMMU_IDR1_NUMSSDNDXB_MASK BITS(11, 8)
#define SMMU_IDR1_NUMSSDNDXB_MSB  11
#define SMMU_IDR1_NUMSSDNDXB_LSB  8
#define SMMU_IDR1_NUMSSDNDXB(n) \
    (((n) << SMMU_IDR1_NUMSSDNDXB_LSB) & SMMU_IDR1_NUMSSDNDXB_MASK)
#define EXTRACT_SMMU_IDR1_NUMSSDNDXB(d) \
    (((d) & SMMU_IDR1_NUMSSDNDXB_MASK) >> SMMU_IDR1_NUMSSDNDXB_LSB)
...
#define EXTRACT_SMMU_IDR1_NUMCB(d) \
    (((d) & SMMU_IDR1_NUMCB_MASK) >> SMMU_IDR1_NUMCB_LSB)
