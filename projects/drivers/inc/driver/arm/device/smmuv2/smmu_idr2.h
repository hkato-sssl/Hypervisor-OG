...
#define SMMU_IDR2_EXNUMSMRG(n)          (((n) << SMMU_IDR2_EXNUMSMRG_LSB) & SMMU_IDR2_EXNUMSMRG_MASK)
#define EXTRACT_SMMU_IDR2_EXNUMSMRG(d)  (((d) & SMMU_IDR2_EXNUMSMRG_MASK) >> SMMU_IDR2_EXNUMSMRG_LSB)
