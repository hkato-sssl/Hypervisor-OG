...
#define EXTRACT_SMMU_IDR2_UBS(d) \
    (((d) & SMMU_IDR2_UBS_MASK) >> SMMU_IDR2_UBS_LSB)
...
#define EXTRACT_SMMU_IDR2_OAS(d) \
    (((d) & SMMU_IDR2_OAS_MASK) >> SMMU_IDR2_OAS_LSB)
...
#define EXTRACT_SMMU_IDR2_IAS(d) \
    (((d) & SMMU_IDR2_IAS_MASK) >> SMMU_IDR2_IAS_LSB)
