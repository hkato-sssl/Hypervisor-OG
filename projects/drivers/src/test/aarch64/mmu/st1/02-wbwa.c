...
/*
 * test/aarch64/mmu/st1/02-wbwa.c
 *
...
/* テスト項目：ミラーリング(Write-back, Read-allocate, Write-allocate)
 *
 * 1) 同じ物理メモリ領域をVA1/VA2の２つにマッピング
 * 2) VA1/VA2共にWrite-backでマッピング
...
errno_t test_aarch64_mmu_st1_02_wbwa(void)
{
    errno_t ret;
    char *va1;
    char *va2;
