...
static void vspi_02_primary(void)
{
    printk("<%s>\n", __func__);
...
static void vspi_02_secondary(void)
{
    while (! start) {
        arm_wfe();
    }
