...
struct soc_ops {
    errno_t (*test_executable_region)(struct soc *soc, uintptr_t addr,
                                      size_t size);
    errno_t (*assert_interrupt_vpc)(struct soc *soc, const struct vpc *vpc,
...
static inline errno_t soc_assert_interrupt_vpc(struct soc *soc,
