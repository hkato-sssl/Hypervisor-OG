...
#define EAGAIN                                                      \
    15 /* Resource unavailable, try again (may be the same value as \
          [EWOULDBLOCK]). */
...
#define EOPNOTSUPP                                                         \
    ENOTSUP /* Operation not supported on socket (may be the same value as \
               [ENOTSUP]). */
...
#define EWOULDBLOCK \
    EAGAIN /* Operation would block (may be the same value as [EAGAIN]). */
