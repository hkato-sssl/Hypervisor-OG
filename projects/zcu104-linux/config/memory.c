...
uint8_t thread_stack_region[CONFIG_NR_CPUS][CONFIG_STACK_SIZE]
...
uint8_t kernel_stack_region[CONFIG_NR_CPUS][CONFIG_KERNEL_STACK_SIZE]
    __attribute__((section(".stack.kernel"), aligned(16)));
