...
static struct soc_device_region rtc_region = {
    .ipa = 0xffa60000,
    .pa = 0xffa60000,
    .size = 0x1000,
    .memory_type = HYP_MMU_MT_DEVICE_nGnRE,
...
static struct soc_device_region ddrc_region = {
    .ipa = 0xfd070000,
    .pa = 0xfd070000,
    .size = 0x1000,
    .memory_type = HYP_MMU_MT_DEVICE_nGnRE,
...
static struct soc_device_region ocm_region = {
    .ipa = 0xff960000,
    .pa = 0xff960000,
    .size = 0x1000,
    .memory_type = HYP_MMU_MT_DEVICE_nGnRE,
...
static struct soc_device_interrupt hvcs_p128_irqs[] = { { 130, 130 }, { 131, 131 } };
